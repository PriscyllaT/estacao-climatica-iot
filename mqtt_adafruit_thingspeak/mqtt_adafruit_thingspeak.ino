...
#define SERVERPORT  1883                   // use 8883 para SSL
#define USERNAME    "priscyllat"
#define MQTT_KEY    "RTLB4NDHEYFD43CU"

/***************************** Global State  **************************************************/

// Cria um cliente WiFi ESP8266 para conectar ao servidor MQTT.
...
float chuvaDigitalValor = 0;
float chuvaAnalogicoValor = 0;
...
void setup() {
  ...
  delay(10);
  dht.begin();
  Serial.println(F("MQTT - Estacao Climática IoT"));
  Serial1.begin(19200);
...
void loop() {
    ...
    float t = dht.readTemperature(); // Lêa temperatura do sensor DHT.
